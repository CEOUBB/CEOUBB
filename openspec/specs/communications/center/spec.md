# communications/center Specification

## Purpose

Define the bounded, private and cross-device communication center that lets enrolled users review recent section announcements and exchange immutable direct messages with the authorized teaching team.
