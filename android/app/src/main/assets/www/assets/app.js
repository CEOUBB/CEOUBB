...
function openWebPortal() {
  openPortalUrl('https://www.ceoubb.com');
}

function openPortalUrl(url) {
  if (typeof window !== 'undefined' && window.StudyBridge && typeof window.StudyBridge.openExternal === 'function') {
    window.StudyBridge.openExternal(url);
    return;
  }
...
function renderProgress() {
  ...
  if (typeof window !== 'undefined' && typeof window.reportEstaticaProgress === 'function') window.reportEstaticaProgress();
}
