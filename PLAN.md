...
- [EN REVISIÓN] **CEO-40 — Carpeta legal: convenio, retención y borrado de datos (2026-08-23).** Rama `elpapijuaco325/ceo-40-preparar-la-carpeta-legal-convenio-retencion-y-borrado-de`, owner Codex/Juako. `docs/legal/` separa el rol contractual futuro (UBB responsable, operador legal de CEOUBB encargado) de la condición independiente actual; propone tabla de retención y supresión verificable, canal de derechos sin WhatsApp, registro honesto de residencia/subencargados y plan de salida. La carpeta deja explícitos los bloqueos: convenio y autorización no firmados, contraparte legal CEOUBB sin individualizar, buzón no provisionado, borrado multisistema parcial, Storage/Turso/Sentry sin evidencia de región/retención y respaldo/restore no probado. Sin cambios de producción ni afirmación de oficialidad.
