...
- [`docs/specs/p5-capacitor-mobile-migration.md`](docs/specs/p5-capacitor-mobile-migration.md) — Capacitor mobile architecture migration & mobile-first UX spec (SDD). Target: Android + iOS unified runtime, native haptics, bottom navigation, bottom sheets, FCM push and clean rewrite of legacy `android/` directory.
