...
- [EN REVISIÓN] **CEO-59 — Editor académico en tres pestañas (2026-08-20).** Rama `elpapijuaco325/ceo-59-feateditor-componente-de-edicion-en-tres-pestanas-visual`, owner Codex/Juako; PR borrador [#59](https://github.com/CEOUBB/CEOUBB/pull/59). `MultimodalEditor` integra modos Visual, Markdown + LaTeX y HTML libre sobre el contrato controlado `body: string`; el conversor conserva como HTML recuperable aquello que Markdown no representa y la proyección visual descarta nodos ejecutables sin `dangerouslySetInnerHTML`. La barra ofrece negrita, cursiva, subrayado, alineaciones, tabla, fórmula, código, callout y enlace; incluye atajos `Ctrl/Cmd+B/I/K`, pestañas automáticas, foco itinerante, anuncios accesibles y controles táctiles de 44 px. No añade dependencias, consultas ni una implementación Android paralela; queda preparado para integrar los renderers de CEO-57/CEO-58 una vez fusionados. Archivos principales: `app/views/classroom/MultimodalEditor.tsx`, `lib/multimodal-editor.ts`, `app/globals.css` y `tests/multimodal-editor.test.ts`. Verificación: `pnpm test` 229/229, `verify:fast` 204/204, invariantes 31/31, lint, Prettier, funciones y OpenSpec limpios; React Doctor sin hallazgos en el alcance de CEO-59; navegador a 1440×1000 y 375×812 sin desborde horizontal, con atajos, flechas y neutralización de scripts verificadas. Sin despliegue a producción.
