...
- [DONE] **P10 — Núcleo académico institucional, aislamiento por matrícula y tiempo real acotado (2026-08-17).** Rama `feat/ceo-10-nucleo-academico-institucional`. Spec [`docs/specs/p10-institutional-lms-evolution.md`](docs/specs/p10-institutional-lms-evolution.md); planes 031–034.
