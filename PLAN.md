...
- [`docs/specs/p7-teacher-workspace-preview.md`](docs/specs/p7-teacher-workspace-preview.md) — preview navegable exclusivamente docente, inspirado conceptualmente en Canvas UdeC, ADECCA y Moodle, con datos sintéticos y aislamiento total del backend productivo. Estado `BORRADOR`; requiere aprobación humana SDD antes de escribir código.
...
- [ACTIVE] **P7 — Espacio docente CEOUBB: especificación y preview navegable.** Rama `codex/teacher-assignment-preview`, owner Codex/Joaquín. Alcance: sólo docentes; recorrido unificado propio inspirado en Canvas UdeC, ADECCA y Moodle; `Vista estudiante` read-only; fixtures en memoria; cero Firebase/Turso/Storage; PR borrador y Vercel Preview, sin producción. La spec está `BORRADOR` y el código queda pausado por el gate humano SDD. `docs/specs/p7-teacher-workspace-preview.md`, `PLAN.md`; después de aprobación, `app/preview/docente/`, pruebas y CSS aislado.
