...
- [`docs/specs/p17-immutable-grade-audit-trail.md`](docs/specs/p17-immutable-grade-audit-trail.md): CEO-7, historial transaccional e inmutable de notas y configuración del libro; implementación en curso mediante Functions autenticadas.
...
- [ACTIVE] **CEO-7 — Historial inmutable de cambios de notas.** Rama `elpapijuaco325/ceo-7-guardar-historial-de-cambios-de-notas-quien-cambio-que-y`, owner Codex/Juako. Alcance: escrituras auditadas por Function, autor y reloj confiables, valor anterior/nuevo, bloqueo de bypass cliente y lotes acotados. Archivos: `firebase/functions/`, `lib/firebase/grades.ts`, `lib/firebase/sdk.ts`, `firebase/firestore.rules`, `firebase/firestore.indexes.json`, `tests/grade-audit.test.ts`, specs y handoff.
