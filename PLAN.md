...
- [BACKLOG] Participants directory: roster search/filter, contact actions and teacher-facing assignment/revocation of the `assistant` role delivered by CEO-25. `app/Classroom.tsx`, `app/api/`
