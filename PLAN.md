...
- [EN REVISIÓN] **CEO-61 — Retrocompatibilidad, seguridad y paridad móvil de publicaciones.** Rama `elpapijuaco325/ceo-61-testclassroom-retrocompatibilidad-de-publicaciones-seguridad`; PR [#57](https://github.com/CEOUBB/CEOUBB/pull/57); owner Codex/Juako. Avisos históricos conservan CRLF y texto dentro de `.academic-prose`; tablas Markdown de seis columnas se construyen con nodos React semánticos seguros; tabla, código y KaTeX confinan overflow horizontal táctil sin ampliar el feed en Web/Capacitor. Sin dependencias, consultas, migraciones ni renderer Android paralelo. Verificación: `verify:fast` 201/201, hashes 24/24, OpenSpec 9/9, invariantes 31/31 y reglas Firebase, lint/typecheck/format limpios, build Next.js 16.3 + suite total 226/226; QA Chromium 360 px sin overflow global ni errores. Spec: [`p16-classroom-retrocompatibility-mobile-parity.md`](docs/specs/p16-classroom-retrocompatibility-mobile-parity.md). Sin despliegue; queda smoke test táctil en dispositivo Android físico después del preview.
