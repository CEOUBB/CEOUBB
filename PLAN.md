...
- [`docs/specs/p8-live-class-banner.md`](docs/specs/p8-live-class-banner.md): CEO-56, contrato aprobado para el enlace Zoom/Teams por sección y su banner inmediato en la portada del aula. Su delta compatible con el arnés vigente vive en `openspec/changes/add-live-class-banner/`.
...
- [ACTIVE] **CEO-56 — Banner de clase en vivo Zoom/Teams.** Rama remota `elpapijuaco325/ceo-56-banner-de-clase-en-vivo-zoom-teams-en-la-portada-del-ramo`, owner Codex/Juako. Implementación rebajada sobre el `main` vigente en un worktree aislado: contrato y normalización del enlace, listener acotado por sección, reglas con aislamiento por matrícula y portada responsive. Pendiente cerrar gates, archivar OpenSpec y publicar el PR.
