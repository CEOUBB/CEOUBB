...
/* Las IA se listan sólo por nombre: la condición de uso es lo que cambia entre
   una y otra, así que la explica el encabezado del grupo y no cada ficha. */
const AI_TIERS: {
  id: string;
  label: string;
  tone: Tone;
...
/* Los beneficios se agrupan por lo que realmente importa al decidir —si sale
   gratis o sólo más barato— en vez de encadenar siete filas equivalentes. */
const PERK_GROUPS: {
  id: string;
  label: string;
  tone: Tone;
  items: { brand: Brand; name: string; note: string; url: string }[];
}[] = [
  {
    id: "gratis",
    label: "Gratis mientras estudias",
    tone: "free",
    items: [
      {
        brand: "github",
