...
export default function SentryExamplePage() {
  ...
  return (
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, -apple-system, sans-serif", padding: "2rem", backgroundColor: "#f4f6f9" }}>
      <div style={{ maxWidth: "520px", width: "100%", background: "#ffffff", padding: "2.5rem", borderRadius: "16px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", textAlign: "center" }}>
        <h1 style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#0f172a", marginBottom: "0.5rem" }}>Verificación Sentry (CEOUBB)</h1>
