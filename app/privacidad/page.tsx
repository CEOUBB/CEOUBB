  ...
  return (
    <main className="policy-page">
      ...
      <article>
        ...
        <p>Centro de Estudio UBB es una plataforma estudiantil independiente y no representa ni reemplaza los servicios oficiales de la Universidad del Bío-Bío.</p>
        <h2>Datos utilizados</h2>
        <p>Al ingresar con Google institucional utilizamos tu nombre, correo institucional verificado, identificador de Firebase y rol de estudiante o profesor. También se almacenan el progreso académico registrado en la plataforma, las publicaciones docentes y los archivos que cada profesor decide subir.</p>
        <h2>Finalidad</h2>
