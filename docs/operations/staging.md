...
- P0.7 conserva evidencia aprobada para el commit Vercel probado; el hosting Cloudflare vigente requiere una medición separada. RPO y RTO continúan como objetivos hasta completar P0.8.
