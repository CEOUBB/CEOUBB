...
function languageOf(code: Element): { key: string; label: string } {
...
function createCodeToolbar(language: { key: string; label: string }): Element {
...
function transformRawHtmlMath(parent: Root | Element): void {
